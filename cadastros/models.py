...
class Fornecedor(models.Model):
    ...
    cnpj = models.IntegerField(max_length=25,verbose_name=u'CNPJ/CPF')
    cidade = models.CharField(blank=True,max_length=200)
    endereco = models.CharField(blank=True,max_length=300)
    telefone = models.IntegerField(max_length=25,verbose_name=u'Telefone')
    fax = models.IntegerField(max_length=25)
